...
// Adapted from React Bits (https://reactbits.dev/backgrounds/light-tunnel) —
// a WebGL fibre-optic tunnel shader with pulses travelling along each cable.
...
interface LightTunnelContext {
  renderer: Renderer;
  program: Program;
  mesh: Mesh;
}

const ctxMap = new WeakMap<HTMLDivElement, LightTunnelContext>();
