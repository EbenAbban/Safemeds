...
// Adapted from React Bits (https://reactbits.dev/backgrounds/liquid-ether) —
// a WebGL fluid (Navier-Stokes) simulation driven by pointer velocity.
...
export default function LiquidEther({
  ...
  // ---- Types for the self-contained simulation classes below ----
  type WebGLManager = {
    output: Output | null;
  ...
  type Output = { simulation: Simulation };
  type Simulation = { options: Record<string, unknown>; resize: () => void };
  type AutoDriver = {
    enabled: boolean;
    speed: number;
    resumeDelay: number;
...
`;
    ...
    class SimulationImpl {
      ...
      poisson!: Poisson;
      pressure!: Pressure;
      constructor(options: Partial<SimulationImpl["options"]>) {
        this.options = {
    ...
    class OutputImpl {
      ...
      output: THREE.Mesh;
      constructor() {
        this.simulation = new SimulationImpl({});
        this.scene = new THREE.Scene();
        this.camera = new THREE.Camera();
    ...
    class WebGLManagerImpl {
      ...
      autoDriver: AutoDriverImpl;
      output!: OutputImpl;
      running = false;
      private _loop: (t?: number) => void;
      private _resize: () => void;
      private _onVisibility: () => void;
      constructor(props: WebGLManagerImpl["props"]) {
        this.props = props;
        ...
        this.autoDriver = new AutoDriverImpl(Mouse, this, {
    ...
    const webgl = new WebGLManagerImpl({
      $wrapper: container,
      autoDemo,
      autoSpeed,
      autoIntensity,
