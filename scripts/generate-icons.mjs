// Generates the PWA icon set from the brand mark in public/icon.svg.
//
...
// The brand mark, inlined so the script stays independent of where the source
// SVG lives. `rounded` matches the favicon; `fullBleed` is for maskable
